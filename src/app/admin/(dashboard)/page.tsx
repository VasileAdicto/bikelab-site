    ...
    <div className="relative space-y-16 max-w-6xl mx-auto px-4 sm:px-6 pb-20 pt-10">
      ...
      <section className="grid gap-12 pt-2 md:grid-cols-[minmax(0,1.4fr)_minmax(0,1fr)] items-start border border-dashed border-border rounded-2xl p-4 sm:p-6 bg-card/40">
        <div className="space-y-8">
          <p className="inline-flex items-center gap-2 rounded-full border border-border bg-card/60 px-4 py-1.5 card-meta text-foreground/90 cursor-pointer">
          ...
          <EditableText
            ...
            as="h1"
            className="font-bold tracking-tight leading-[1.1] text-[1.11rem] sm:text-[1.33rem] md:text-[1.78rem] lg:text-[2.22rem] text-foreground cursor-pointer"
            save={saveText}
            onSelect={setSelected}
          />
          ...
          <EditableText
            id="hero.description"
            initial="Наш райдер - потужний як шосер, вправний як гравіті-воїн, захищений як мамина черешня 🍒 BikeLab — це коли сила, техніка і методика сходяться в один результат."
            valueFromContent={get(
              "hero.description",
              "Наш райдер - потужний як шосер, вправний як гравіті-воїн, захищений як мамина черешня 🍒 BikeLab — це коли сила, техніка і методика сходяться в один результат."
            )}
          ...
          <div className="flex flex-wrap items-center gap-4">
            <button
              className="group inline-flex items-center gap-2 rounded-full border border-border bg-card/80 px-6 py-2.5 font-mono uppercase tracking-[0.25em] font-medium text-foreground cursor-pointer hover:bg-steel/80 hover:border-foreground/20"
              style={{
          ...
          <div className="grid grid-cols-3 gap-2 sm:gap-2.5 pt-2 text-xs font-mono uppercase tracking-[0.2em] w-full max-w-[min(100%,33rem)]">
            {[
              ...
              { idValue: "stats.2.value", idLabel: "stats.2.label", defV: "100+ members", defL: "strong community" },
            ].map((s) => (
              <div
                key={s.idLabel}
